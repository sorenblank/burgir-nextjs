...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 border-b py-[14px] bg-n-white border-b-n-richblackfogra`}>
      <div className='container flex justify-between items-center lg:gap-[20px]'>
        ...
        <nav className={`${openNavigation ? 'flex' : 'hidden'} fixed top-[4.5rem] left-0 right-0 bottom-0 bg-white lg:bg-transparent lg:static lg:flex lg:ml-auto`}>
